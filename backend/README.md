...
- `/med-error/reports/summary6` - สรุปอุบัติการณ์ที่ได้ RCA แล้ว + summary stats (v1.9.0+)
- `/med-error/reports/summary10` / `stat-volume` - สถิติใบสั่งยา/วันนอน + อัตรา/1,000 (v1.8.0+)
