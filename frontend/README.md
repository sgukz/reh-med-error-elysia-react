...
- **Likelihood Criteria Manager (v1.19.0, v1.20.0 rewrite UX, v1.23.0 แยก 6 ประเภท)**: หน้าจัดการเกณฑ์ความถี่ → Likelihood — **Tabs 6 ประเภท Error** (Prescription / Dispensing / Pre-Administration / Administration / Processing / Transcribing) แต่ละประเภทตั้งเกณฑ์อิสระ (scrollable tabs), **Visual Range Bar** color-coded ต่อ level, **ScorePill EN+TH** label (Frequent/Likely/Possible/Unlikely/Rare/Never), **Validation visual** (gap/overlap/missing/invalid) พร้อม badge นับ issue ที่ tab title — Admin (rule=9) เท่านั้น
